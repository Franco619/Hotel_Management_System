...
<div class="col-sm-9 text-secondary">
 <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror" id="old_password" placeholder="enter current password"  />
                        @error('old_password')
...
<div class="row mb-3">
<div class="col-sm-3">
<h6 class="mb-0">Confirmed Pasword</h6>
</div>
<div class="col-sm-9 text-secondary">
